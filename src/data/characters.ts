...
export const CHARACTERS: Record<CharacterId, Character> = {
  estelle: {
    id: "estelle", name: "릴리아", hasPortrait: true, color: "#ffdf9e", // 금발 — 웜골드
    body: GRID_EMOTIONS,
    bust: GRID_EMOTIONS,
    fallback: {},
  },
  ...
  chancellor: { id: "chancellor", name: "재상 메피안", hasPortrait: true, color: "#b8b09b",
  ...
  eden: {
    id: "eden", name: "벨포르", hasPortrait: true, color: "#cfe0f5", // 백금발 — 플래티넘
    body: GRID_EMOTIONS, bust: GRID_EMOTIONS, fallback: {},
  },
  valen: {
    id: "valen", name: "벨리안", hasPortrait: true, color: "#e8a06d", // 제국 제1황태자 (적발·와인 망토) — 임시명, 앰버
    body: GRID_EMOTIONS,
    bust: GRID_EMOTIONS,
    fallback: {},
  },
